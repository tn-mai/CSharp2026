...
以下の3つのプログラムを追加して、画像を逆さまにしたトゲブロックを作成しなさい。
  1. 「下向きトゲブロックの配列」を追加(名前は<code>downSpikeList</code>とします)
  2. <code>downSpikeList</code>を画面に表示
  3. <code>downSpikeList</code>とプレイヤーが衝突したら、死亡状態にする
</pre>
