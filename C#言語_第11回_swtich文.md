[C#言語2026 第10回]
 ...
 1. プログラムを書いてみよう       プログラミングの基本を覚えてもらうために、ごく基本的なターン制バトルプログラムを作らせる
 2. 変数と型                      基本型について解説し、変数宣言の手順を覚えてもらう
 3. if文                         if文と条件式について解説し、基本的な条件分岐の作成手順を覚えてもらう
 4. プログラムの実行順序とスコープ  プログラムの実行順序について、if文を交えて解説し、実行順と変数のスコープについて覚えてもらう
 5. 配列とfor文の真の姿(old:配列とリスト)           配列について解説し、添字の使い方について覚えてもらう
 6. 振り返り                      変数、if文、配列の復習

 7. 名前空間とクラスとメソッドの概要(old:for文)    Mainメソッドとクラス、名前空間の関係を覚えてもらう
 8. ジャンプゲームの改良(old:for文と配列)          7回で作ったジャンプゲームの改良を通じて、if、for、配列に習熟する
 9. メソッドの作りかた(old:switch文)              ジャンプゲームの機能をメソッド化することで、メソッドの作りかたを覚えてもらう
10. クラスと構造体(old:構造体)    構造体の目的について解説し、構造体の作成手順と、どういうときに構造体を使うべきかを覚えてもらう
11. メソッド(1)                  メソッドの目的について解説し、メソッドの作成手順を覚えてもらう
12. メソッド(2)                  メソッドを使うことによるプログラミング上のメリットについて学習する
13. 前期の振り返り                for文、構造体、メソッドの復習

6回まではコンソールアプリを作成してC#の書きかたに慣れる。
7回からはWindowsアプリでグラフィックスを扱う。まずはジャンプゲームをグラフィックス付きで作り、2D衝突判定や表示物の管理を学習する。



switch文, リスト型, foreach文, 構造体
