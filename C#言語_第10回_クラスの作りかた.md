...
&emsp;次々回: プレイヤーのアニメーション, 敵の表示, 敵の衝突判定, タイトル状態, 横スクロール,<br>
&emsp;&emsp;&emsp;&emsp;&ensp;ステージ数を増やす
...
プログラムが書けたら`>PenguinsJump`ボタンをクリックしてアプリを実行してください。歩いて空中のブロックの端を越えたとき、プレイヤーが落下したら成功です。
