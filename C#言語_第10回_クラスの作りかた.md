...
Webブラウザで以下のURLにアクセスして、ページを開いてください。
...
>
>&emsp;$ X = 800 \times 0.35 - \frac{2300}{2} \times 0.35^2 $
>
>&emsp;$ X = 139.125 $
>
>となるので、ジャンプの高さは約139ドットだと分かります。
>
...
「そういうゲーム」と言い張れなくもないですが、やっぱり不自然です。<br>
そこで、キー入力に応じて表示する向きを変えましょう。
