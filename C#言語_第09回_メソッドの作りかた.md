...
+          g, "DINO RUN", fontTitleLogo, new Point(350, 210), Color.Black);
+
+        // タイトルロゴ
+        TextRenderer.DrawText(
+          g, "DINO RUN", fontTitleLogo, new Point(340, 200), Color.Green);
+
+        // 操作メッセージ
+        TextRenderer.DrawText(
...
-        TextRenderer.DrawText(
+          g, "DINO RUN", fontTitleLogo, new Point(350, 210), Color.Black);
+        DrawText(g, "DINO RUN", fontTitleLogo, 350, 210, Color.Black);

         // タイトルロゴ
-        TextRenderer.DrawText(
-          g, "DINO RUN", fontTitleLogo, new Point(340, 200), Color.Green);
+        DrawText(g, "DINO RUN", fontTitleLogo, 340, 200, Color.Green);
